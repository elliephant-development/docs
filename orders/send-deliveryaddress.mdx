...
The details you send as part of the [POST/api/order](/api-reference/endpoint/products) method in the `delivery_address` field of the `recipient_details` field.
