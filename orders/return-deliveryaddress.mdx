...
The details you send as part of the [GET/api/order/:id](/api-reference/endpoint/products) method in the `delivery_address` field of the `recipient_details` field of the `recipients` field.
