...
| Field                         | Description                           |
| ----------------------------- | ------------------------------------- |
| `product_id`                  | The product id used to identify the product on our site. You use this value as the ID in the [GET/api/product/:id](/api-reference/endpoint/products) method. |
